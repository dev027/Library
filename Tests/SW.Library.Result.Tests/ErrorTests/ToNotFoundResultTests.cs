// <copyright file="ToNotFoundResultTests.cs" company="Steve Wright">
...
/// <summary>
/// Tests for <see cref="Error.ToNotFoundResult"/> method.
/// </summary>
[TestClass]
public class ToNotFoundResultTests
{
    /// <summary>
    /// Test that when called then it returns expected result.
    /// </summary>
    [TestMethod]
    public void Error_ToNotFoundResult_WhenCalled_ReturnsExpectedResult()
    {
        // ARRANGE
        ...
        // ACT
        Result result = sourceError.ToNotFoundResult();
    ...
    /// </summary>
    [TestMethod]
    public void Error_ToNotFoundResult_WhenErrorIsNone_ThrowsInvalidOperationException()
    {
        // ARRANGE
        Error sourceError = Error.None;

        // ACT & ASSERT
        Assert.ThrowsExactly<InvalidOperationException>(() => sourceError.ToNotFoundResult());
    }
}
