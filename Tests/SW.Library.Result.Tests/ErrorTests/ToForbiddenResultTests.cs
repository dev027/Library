// <copyright file="ToForbiddenResultTests.cs" company="Steve Wright">
...
/// <summary>
/// Tests for <see cref="Error.ToForbiddenResult"/> method.
/// </summary>
[TestClass]
public class ToForbiddenResultTests
{
    /// <summary>
    /// Test that when called then it returns expected result.
    /// </summary>
    [TestMethod]
    public void Error_ToForbiddenResult_WhenCalled_ReturnsExpectedResult()
    {
        // ARRANGE
        ...
        // ACT
        Result result = sourceError.ToForbiddenResult();
    ...
    /// </summary>
    [TestMethod]
    public void Error_ToForbiddenResult_WhenErrorIsNone_ThrowsInvalidOperationException()
    {
        // ARRANGE
        Error sourceError = Error.None;

        // ACT & ASSERT
        Assert.ThrowsExactly<InvalidOperationException>(() => sourceError.ToForbiddenResult());
    }
}
