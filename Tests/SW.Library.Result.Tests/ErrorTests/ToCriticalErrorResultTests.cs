// <copyright file="ToCriticalErrorResultTests.cs" company="Steve Wright">
...
/// <summary>
/// Tests for <see cref="Error.ToCriticalErrorResult"/> method.
/// </summary>
[TestClass]
public class ToCriticalErrorResultTests
{
    /// <summary>
    /// Test that when called then it returns expected result.
    /// </summary>
    [TestMethod]
    public void Error_ToCriticalErrorResult_WhenCalled_ReturnsExpectedResult()
    {
        // ARRANGE
        ...
        // ACT
        Result result = sourceError.ToCriticalErrorResult();
    ...
    /// </summary>
    [TestMethod]
    public void Error_ToCriticalErrorResult_WhenErrorIsNone_ThrowsInvalidOperationException()
    {
        // ARRANGE
        Error sourceError = Error.None;

        // ACT & ASSERT
        Assert.ThrowsExactly<InvalidOperationException>(() => sourceError.ToCriticalErrorResult());
    }
}
